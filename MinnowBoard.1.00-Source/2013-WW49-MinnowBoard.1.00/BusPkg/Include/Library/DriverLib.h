...
typedef struct
{
  ...
  //
  CONST EFI_COMPONENT_NAME_PROTOCOL * ComponentNameProtocol;    ///<  Address of component name protocol
  CONST EFI_COMPONENT_NAME2_PROTOCOL * ComponentName2Protocol;  ///<  Address of component name 2 protocol
  CONST EFI_UNICODE_STRING_TABLE * ControllerNameStringTable;   ///<  String table for ::DlGetControllerName
  CONST EFI_UNICODE_STRING_TABLE * DriverNameStringTable;       ///<  String table for ::DlGetDriverName

  //
  //  Driver Binding Protocol support
  //
  EFI_DRIVER_BINDING_PROTOCOL * DriverBindingProtocol;    ///<  Address of driver binding protocol

  //
  //  Loaded Image Protocol support
  //
  EFI_IMAGE_UNLOAD Unload;                  ///<  Driver unload routine
} DL_DRIVER_LIB;
...
extern EFI_GUID * mDriverProtocol;      ///<  Driver protocol GUID attached to the controller handle
