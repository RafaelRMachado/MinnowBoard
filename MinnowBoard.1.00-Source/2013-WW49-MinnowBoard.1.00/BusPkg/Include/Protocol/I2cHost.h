/** @file
  I2C host interface declaration

  A driver or application uses the I2C host protocol to
  perform transactions on the I2C bus.  With the support
  of the I2C platform driver, access is possible to any
  device on the I2C bus, even devices behind multiplexers
  and switches.
