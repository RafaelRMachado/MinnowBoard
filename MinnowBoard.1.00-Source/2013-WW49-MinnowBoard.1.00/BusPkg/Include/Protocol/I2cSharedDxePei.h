/** @file
  I2C data structures shared between DXE and PEI
...
#ifndef __I2C_SHARED_DXE_PEI_H__
#define __I2C_SHARED_DXE_PEI_H__
...
typedef struct {
  ...
  ///
  /// Description of the I2C operations
  ///
  EFI_I2C_OPERATION Operation [ 1 ];
} EFI_I2C_REQUEST_PACKET;

#endif  //  __I2C_SHARED_DXE_PEI_H__
